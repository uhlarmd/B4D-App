...
function MainCtrl($http, $scope, $state) {
    ...
    $scope.logoutNow = function() {
        $http.get('http://www.thedig.co/data/api/logout').success(function(resp){
...
function dashCtrl($http, $scope, $state, SweetAlert) {
    $scope.gotoupload = function(){$state.go('upload')};

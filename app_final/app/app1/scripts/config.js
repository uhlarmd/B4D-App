...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
        .state('landing', {
            ...
            data: { pageTitle: 'Ink Me', specialClass: 'landing-page' },
            resolve: {
        ...
        .state('dashboard.orders', {
            ...
            data: { pageTitle: 'Orders', specialClass: 'gray-bg' }
        })
        .state('upload', {
            url: "/upload",
            templateUrl: "views/upload.html",
            data: { pageTitle: 'Upload Form' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
        ...
        .state('dashboards.upload.step_one', {
            url: '/step_one',
            templateUrl: 'views/wizard/step_one.html',
            data: { pageTitle: 'Wizard form' }
        })
        .state('dashboards.upload.step_two', {
            url: '/step_two',
            templateUrl: 'views/wizard/step_two.html',
            data: { pageTitle: 'Wizard form' }
        })
        .state('dashboards.upload.step_three', {
            url: '/step_three',
        ...
        .state('details', {
            ...
            data: { pageTitle: 'Details', specialClass: 'gray-bg' },
